...
let server;
const sslKeyPath =
  process.env.SSL_KEY_PATH || path.join(__dirname, "private", "key.pem");
const sslCertPath =
  process.env.SSL_CERT_PATH || path.join(__dirname, "private", "cert.pem");
const useHttps =
...
// Endpoint to get ICE/TURN server config
